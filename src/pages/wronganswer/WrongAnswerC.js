...
// 학습자와 오답문제풀이정보조회, 이미지 조회, pass, open, (prohibited, resricted)
import {
...
export const WrongAnswerC = (props) => {
    ...
    const learn02_start = () => {
        ...
        $('#learn02_prohibited').click(function () {
            UpdateWrongAnswer_ApiCall($(this).data('value'), $(images[currentImageIndex]).data('value'));
            learn02_btn();
        });
                ...
                <div className="learn_con">
                    ...
                    <div className="xbt_top">
                        ...
                        <div className="learnct01">
                            <ul>
                                <li>
                                    <h1 className="contit">오답문제풀이(Cut)</h1>
                                </li>
                                <li>
